		...
		try {
			...
			while (!"exit".equalsIgnoreCase(line)) {
				...
				if (line.isEmpty() || line.equalsIgnoreCase("no")) {
					...
					Method stub = (Method) Naming.lookup("rmi://localhost:5000/lab6"); // replace 35.39.165.77 with
																							// your
					// server's IP address
					System.out.println(stub.action(a, b));
					
					CallbackServerInterface h = (CallbackServerInterface) Naming
							.lookup("rmi://localhost:5000/lab9");
